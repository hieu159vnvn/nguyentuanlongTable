...
export interface ApiBankInfoBankInfo extends Struct.SingleTypeSchema {
  collectionName: 'bank_info';
  info: {
    displayName: 'Bank Info';
    pluralName: 'bank-infos';
    singularName: 'bank-info';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customerCode: Schema.Attribute.UID &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
...
export interface ApiPricingLongTermPackagePricingLongTermPackage
  extends Struct.CollectionTypeSchema {
  collectionName: 'pricing_long_term_packages';
  info: {
    displayName: 'Pricing Long Term Package';
    pluralName: 'pricing-long-term-packages';
    singularName: 'pricing-long-term-package';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    bonusHours: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pricing-long-term-package.pricing-long-term-package'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    price: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiPricingShortTermPricingShortTerm
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pricing-short-term.pricing-short-term'
    > &
      Schema.Attribute.Private;
    maxHours: Schema.Attribute.Integer;
    minHours: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiRentalAccessoryRentalAccessory
  extends Struct.CollectionTypeSchema {
  collectionName: 'rental_accessories';
  info: {
    description: '';
    displayName: 'Rental Accessory';
    pluralName: 'rental-accessories';
    singularName: 'rental-accessory';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rental-accessory.rental-accessory'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiRentalRental extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    rentalAccessories: Schema.Attribute.Relation<
      'oneToMany',
      'api::rental-accessory.rental-accessory'
    >;
    shortTermRate: Schema.Attribute.Relation<
      'manyToOne',
      'api::pricing-short-term.pricing-short-term'
    >;
    ...
    type: Schema.Attribute.Enumeration<['short', 'package']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::bank-info.bank-info': ApiBankInfoBankInfo;
      'api::customer.customer': ApiCustomerCustomer;
      'api::invoice.invoice': ApiInvoiceInvoice;
      'api::pricing-long-term-package.pricing-long-term-package': ApiPricingLongTermPackagePricingLongTermPackage;
      'api::pricing-short-term.pricing-short-term': ApiPricingShortTermPricingShortTerm;
      'api::rental-accessory.rental-accessory': ApiRentalAccessoryRentalAccessory;
